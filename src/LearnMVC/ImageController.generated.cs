...
namespace LearnMVC.Controllers {
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_ImageController: LearnMVC.Controllers.ImageController {
        public T4MVC_ImageController() : base(Dummy.Instance) { }

        public override System.Web.Mvc.ActionResult Index(string imageName) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Index);
            callInfo.RouteValueDictionary.Add("imageName", imageName);
            return callInfo;
        }
